...
*๏ 𝐻𝑒𝑦 𝐼'𝑚* {} ✨ 
➻ 𝐺𝑟𝑜𝑢𝑝 𝑚𝑎𝑛𝑎𝑔𝑒𝑚𝑒𝑛𝑡 + 𝑚𝑢𝑠𝑖𝑐 𝑏𝑜𝑡 𝑤𝑖𝑡ℎ 𝑙𝑜𝑡 𝑜𝑓 𝑓𝑒𝑎𝑡𝑢𝑟𝑒𝑠 .𝐼 𝑐𝑎𝑛 𝑚𝑎𝑛𝑎𝑔𝑒 𝑦𝑜𝑢𝑟 𝑔𝑟𝑜𝑢𝑝𝑠 𝑤𝑖𝑡ℎ 𝑒𝑎𝑠𝑒!
...
ʏᴏᴜ ᴄᴀɴ ᴅɪʀᴇᴄᴛʟʏ ᴄᴏɴᴛᴀᴄᴛ ᴍʏ [ᴅᴇᴠᴇʟᴏᴩᴇʀ](https://t.me/thefather69) ғᴏʀ ᴅᴏɴᴀᴛɪɴɢ ᴏʀ ʏᴏᴜ ᴄᴀɴ ᴠɪsɪᴛ ᴍʏ [sᴜᴩᴩᴏʀᴛ ᴄʜᴀᴛ](https://t.me/TigerNetwork) ᴀɴᴅ ᴀsᴋ ᴛʜᴇʀᴇ ᴀʙᴏᴜᴛ ᴅᴏɴᴀᴛɪᴏɴ."""
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        ...
                        InlineKeyboardButton(
                            text="ɢɪᴛʜᴜʙ",
                            callback_data="https://github.com/TigerNetwork",
                        ),
                    ],
                    [
...
*ʜᴇʀᴇ ɪs ᴍʏ sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ :* [ɢɪᴛʜᴜʙ](https://github.com/TigerNetwork/FallenRobot)

{BOT_NAME} ɪs ʟɪᴄᴇɴsᴇᴅ ᴜɴᴅᴇʀ ᴛʜᴇ [ᴍɪᴛ ʟɪᴄᴇɴsᴇ](https://github.com/TigerNetwork/FallenRobot/blob/master/LICENSE).
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 5215836363 and DONATION_LINK:
            update.effective_message.reply_text(
                f"» ᴛʜᴇ ᴅᴇᴠᴇʟᴏᴩᴇʀ ᴏғ {BOT_NAME} sᴏʀᴄᴇ ᴄᴏᴅᴇ ɪs [ᴀɴᴏɴʏᴍᴏᴜs](https://t.me/thefather69)."
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendAnimation(
                f"@{SUPPORT_CHAT}",
                animation="https://te.legra.ph/file/2cf34f4e65867a745a556.mp4",
                caption=f"""
